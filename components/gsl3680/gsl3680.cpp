// Vendored from https://github.com/kvj/esphome branch jd9365_gsl3680
// (commit dca6f3e, 2025-10-16 "gsl3680: Migrate to new i2c driver").
//
// Local change vs upstream: mark_failed(const char *) was deprecated in ESPHome
// 2025.12 and removed in 2026.6, so the call below uses the LOG_STR form. Keep
// this note if re-syncing from upstream.
#include "gsl3680.h"
